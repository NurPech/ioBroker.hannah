...
export class GrpcClient {
     ...
     */
    getSatellites(): Promise<Array<{ device_id: string; room: string; address: string; serial?: string; display_name?: string }>> {
     ...
     * On first connect the satellite sends the seed; Hannah links serial → pre-config and marks paired.
     *
